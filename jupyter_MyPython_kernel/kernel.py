...
##do_runcode
    def do_runcode(self,return_code,fil_ename,magics,code, silent, store_history=True,
        ...
        retstr=''
        ##代码运行前
        p = self.create_jupyter_subprocess(['python3',fil_ename]+ magics['_st']['args'],cwd=None,shell=False,env=self.addkey2dict(magics,'env'),magics=magics)
...
##do_create_codefile
    def do_create_codefile(self,magics,code, silent, store_history=True,
        ...
        retinfo=self.get_retinfo()
        retstr=''
        source_file=self.create_codetemp_file(magics,code,suffix='.py')
        newsrcfilename=source_file.name
        fil_ename=newsrcfilename
        return_code=True
